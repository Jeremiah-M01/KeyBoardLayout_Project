...
public class KeyboardLayout_TestCasesSubsetForStudents_2_ENVIRONMENT extends KeyboardLayout_TestCasesSubsetForStudents_1_MAP_UTILS
{
	//STUDENT: YOU *MUST* CHANGE THE VALUE OF LAST_NAME
	protected static final String LAST_NAME = "Martinez";
	protected static final String CLASS_NAME = "AppleNumericMB110LLKeyboardMetricsImpl";
	private static final int REQUIRED_JAVA_VERSION = 9;	//Need Class.getPackageName() below
	
	protected static final String PACKAGE_NAME = "keyboard";
	protected static final String SKELETON = "Skeleton";
	protected static final String SEPARATOR = "_";
	
	protected static final String EXPECTED_PREFIX = CLASS_NAME + SEPARATOR;
	...
	public void correctClassNamePrefix()
	{
		...
		String expectedPrefix = EXPECTED_PREFIX;
		String actualClassName = getClassNameWithoutPackage(AppleNumericMB110LLKeyboardMetricsImpl_Martinez.class);
	...
	public void validLastNameStructureTest()
	{
		...
		String lastName = getFileNameSuffix();
	...
	{
		TEST_GOAL_MESSAGE = "Check whether class ends with a last name with valid structure";
		String expectedLastName = getFileNameSuffix();
	...
	{
		TEST_GOAL_MESSAGE = "Check whether Java specification version >= " + REQUIRED_JAVA_VERSION;
	...
	public void correctPackageTest()
	{
		...
		String actualPackageName = AppleNumericMB110LLKeyboardMetricsImpl_Martinez.class.getPackageName();
